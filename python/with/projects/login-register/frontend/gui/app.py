...
class LoginRegisterApp(customtkinter.CTk):
    def __init__(self):
        ...
        self.registerButton = customtkinter.CTkButton(self, text="register", command=self.registerButton_callback)
        self.registerButton.grid(row=0, column=0, padx=10, pady=10, sticky="ew")

        self.loginButton = customtkinter.CTkButton(self, text="login", command=self.loginButton_callback)
