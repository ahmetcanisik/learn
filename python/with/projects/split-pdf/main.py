...
def clean_student_data(text):
    ...
    locations = ['AKÇAKALE', 'BİRECİK', 'BOZOVA', 'CEYLANPINAR', 'EYYÜBİYE', 'HALFETİ', 
                'HALİLİYE', 'HARRAN', 'HİLVAN', 'KARAKÖPRÜ', 'SİVEREK', 'SURUÇ', 'VİRANŞEHİR']
...
def main():
    ...
    pdf_files = [f for f in os.listdir('.') if f.startswith('ogrenci_yerleri_listesi') and f.endswith('.pdf')]
